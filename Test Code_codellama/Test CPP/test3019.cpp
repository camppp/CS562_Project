...
public:
    // Constructor to initialize the vector with given values
    ...
    // Method to calculate the dot product of two SVector5 objects
    ...
    // Method to calculate the cross product of two SVector5 objects
