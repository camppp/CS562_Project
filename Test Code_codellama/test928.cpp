...
int main() {
    ...
    std::cout << "Enter the action (l for laser scan, p for pose): ";
    std::cin >> action;

    // Call the retrieveAndPrintData function with the action and robot object
    retrieveAndPrintData(action, robot);
